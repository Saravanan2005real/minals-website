...
export default function Home() {
  return (
    <main>
      ...
      {/* ─── Hero ─── */}
      <section className="px-[5%] py-[50px] lg:py-[80px] flex flex-col lg:flex-row items-center bg-[radial-gradient(circle_at_70%_50%,#ffffff_0%,#fafafa_100%)] min-h-[80vh] text-center lg:text-left gap-10 lg:gap-0">
